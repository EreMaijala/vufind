...
class PluginManager extends \VuFind\ServiceManager\AbstractPluginManager
{
    ...
    protected $aliases = [
        ...
        'paymentfee' => Payment::class,
        'paymenteventlog' => PaymentEventLog::class,
    ...
    protected $factories = [
        ...
        Payment::class => RowGatewayFactory::class,
        PaymentFee::class => RowGatewayFactory::class,
        PaymentEventLog::class => RowGatewayFactory::class,
