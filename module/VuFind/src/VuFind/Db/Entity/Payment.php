...
class Payment implements PaymentEntityInterface
{
     ...
     * @var DateTime
     */
    #[ORM\Column(name: 'paid', type: 'datetime', nullable: false)]
    protected $paid;
     ...
     * @var DateTime
     */
    #[ORM\Column(name: 'registration_started', type: 'datetime', nullable: false)]
     ...
     * @var DateTime
     */
    #[ORM\Column(name: 'reported', type: 'datetime', nullable: false)]
    protected $reported;
