 ...
 * @link     https://vufind.org/wiki/development Wiki
 */
class Segment extends \Laminas\Router\Http\Segment
{
    /**
    ...
    public function reset($options = []): static
    {
        ...
        if (!isset($options['route'])) {
            throw new \Laminas\Router\Exception\InvalidArgumentException('Missing "route" in options array');
        }

        parent::__construct($options['route'], $options['constraints'] ?? [], $options['defaults'] ?? []);
